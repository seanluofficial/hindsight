...
| 005 | Post-earnings-announcement drift (PEAD) | 20-day, 10bps quintile L/S Sharpe on the surprise signal (HOLDOUT) | `draft` (dev read; holdout reserved) | dev: right sign, Sharpe 0.14 (20d) → 0.23 (60d), sub-threshold | pending |
