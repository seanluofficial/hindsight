...
| 009 | Insider cluster-buying, whole-market / small-cap | 20-day, 10bps mean market-excess of cluster-buy events, whole-market universe; H1 positive (HOLDOUT) | `null` (holdout spent) | refined +65 bps/20d, Sharpe 0.30 on dev → **−122 bps on holdout, −65 bps on 2025+ FORWARD**; H1 rejected on two out-of-sample periods. Positive daily-book variant discarded for survivorship bias | −5.10 (t) |
| 010 | Cross-sectional 12-1 momentum, whole-market / small-cap | 20-day hold, 10bps quintile L/S Sharpe; H1 positive (HOLDOUT) | `null` (dev; **holdout reserved**) | 20d-hold primary null (Sharpe 0.16); longer holds clear the bar (60d L/S 0.51 @25bps) but long-only is negative — short-borrow illusion | 0.16 (Sharpe) |
